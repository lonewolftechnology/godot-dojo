...
protected:
    static void _bind_methods() {
        ...
        BIND_ENUM_CONSTANT(ContainsAll);
        ...
        BIND_ENUM_CONSTANT(ContainsAny);
        ...
        BIND_ENUM_CONSTANT(ArrayLengthEq);
        ...
        BIND_ENUM_CONSTANT(ArrayLengthGt);
        ...
        BIND_ENUM_CONSTANT(ArrayLengthLt);
...
VARIANT_ENUM_CAST(MemberClause::ComparisonOperator)