...
protected:
    ...
    ClassDB::bind_method(D_METHOD("set_world_addresses", "p_world_addresses"), &DojoPlayerAchievementQuery::set_world_addresses);
    ...
    ClassDB::bind_method(D_METHOD("set_player_addresses", "p_player_addresses"), &DojoPlayerAchievementQuery::set_player_addresses);
