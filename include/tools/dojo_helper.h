...
protected:
    ...
    static void _bind_methods() {
        ...
        ClassDB::bind_static_method("DojoHelpers", D_METHOD("get_custom_setting", "category", "setting"),
                                    &DojoHelpers::get_custom_setting);

        ClassDB::bind_static_method("DojoHelpers", D_METHOD("signed_to_u32_offset", "signed_value"),
                                    &DojoHelpers::signed_to_u32_offset);
        ClassDB::bind_static_method("DojoHelpers", D_METHOD("u32_to_signed_offset", "u32_value"),
                                    &DojoHelpers::u32_to_signed_offset);
        ...
        // 64
        ClassDB::bind_static_method("DojoHelpers", D_METHOD("float_to_fixed_64", "value"),
                                    &DojoHelpers::float_to_fixed_64);
        ClassDB::bind_static_method("DojoHelpers", D_METHOD("fixed_to_float_64", "value"),
                                    &DojoHelpers::fixed_to_float_64);
        // 128
        ...
        ClassDB::bind_static_method("DojoHelpers", D_METHOD("string_to_field_element", "str"),
                                    &DojoHelpers::string_to_field_element);

        ClassDB::bind_static_method("DojoHelpers", D_METHOD("double_to_variant_fp", "value", "precision"),
                                    &DojoHelpers::double_to_variant_fp);
        ClassDB::bind_static_method("DojoHelpers", D_METHOD("variant_to_double_fp", "value", "precision"),
                                    &DojoHelpers::variant_to_double_fp);

        ClassDB::bind_static_method("DojoHelpers", D_METHOD("bytes_to_i128_string", "bytes"),
                                    &DojoHelpers::bytes_to_i128_string);
        ClassDB::bind_static_method("DojoHelpers", D_METHOD("bytes_to_u128_string", "bytes"),
